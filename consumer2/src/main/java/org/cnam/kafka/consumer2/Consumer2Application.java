package org.cnam.kafka.consumer2;

import org.apache.kafka.clients.consumer.ConsumerConfig;
import org.apache.kafka.clients.consumer.ConsumerRecords;
import org.apache.kafka.clients.consumer.KafkaConsumer;
import org.apache.kafka.common.serialization.StringDeserializer;
import org.cnam.kafka.consumer2.model.StationLocation;
import org.cnam.kafka.consumer2.model.StationLocationDeserializer;
    ...
    public Consumer2Application() {
        ...
        Executors.newScheduledThreadPool(1).scheduleAtFixedRate(() -> {
            ...
            consumerRecords.forEach(cr -> {
                ...
                System.out.println("CONSUMER2 :  Records : Key=>" + cr.key() + ", value=>" + cr.value() + ", offset=>" + cr.offset() + " partition=>"+ cr.partition());
            });
